...
from PySide6.QtWidgets import QWidget, QPushButton, QVBoxLayout, QHBoxLayout, QComboBox
...
class Widget(QWidget):
    def __init__(self):
        ...
        planets = ["Earth", "Venus", "Mars", "Pluto", "Saturn"]
        self.combo_box.addItems(planets)
